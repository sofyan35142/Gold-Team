        ...
        <!-- Content -->
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                    <h5 class="card-header">Tambah Buku Reparasi</h5>
                    <div class="card-body">
                        <form action="/insertreparasi" method="POST" enctype="multipart/form-data">
                                @csrf
                        <div>
                        <label for="defaultFormControlInput" class="form-label">Nama Buku</label>
                        <input type="text" name="namabuku" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" required/>
                        </div>
                        <br/>
