...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template-semi-dark/pages-account-settings-security.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Nov 2022 01:21:02 GMT -->
      ...
      <div class="row">
        ...
        <div class="col-md-7 order-md-1 order-0">
          <div class="text-center mt-md-n5 pt-md-2 mx-3 mx-md-0">
            <img src="../../assets/img/illustrations/boy-working-light.png" class="img-fluid" alt="Api Key Image" width="300" data-app-light-img="illustrations/boy-working-light.png" data-app-dark-img="illustrations/boy-working-dark.html">
          </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template-semi-dark/pages-account-settings-security.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Nov 2022 01:21:03 GMT -->
</html>
