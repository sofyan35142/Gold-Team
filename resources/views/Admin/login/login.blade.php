...
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-semi-dark" data-assets-path="../../assets1/" data-template="vertical-menu-template-semi-dark">


<!-- Mirrored from pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/vertical-menu-template-semi-dark/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Nov 2022 01:21:10 GMT -->
<head>
    <meta charset="utf-8" />
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo h3 mb-0 fw-bold">Sketsu</span>
                            </a>
                        </div>
                        <!-- /Logo -->
    ...
    <!-- Page JS -->
    <script src="../../assets1/js/pages-auth.js"></script>
</body>
