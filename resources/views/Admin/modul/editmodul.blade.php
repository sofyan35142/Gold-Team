        ...
        <!-- Content -->
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                    <h5 class="card-header">Edit Modul</h5>
                    <div class="card-body">
                        <form action="/modul/update/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                        ...
                        <input type="text" name="judulsidebar1" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" value="{{ $data->judulsidebar1 }}" required/>
                        </div>
                        ...
                        <input type="text" name="linksidebar1" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" value="{{ $data->linksidebar1 }}" required/>
                        </div>
                        ...
                        <input type="text" name="judulsidebar2" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" value="{{ $data->judulsidebar2 }}" required/>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Update Foto Kegiatan Produktif</label>
                            <br/>
                            <img class="img mb-3" src="{{ asset('foto/jurusan/' . $data->fotosidebar2) }}" alt="" style="width: 100px;">
                            <input type="file" name="fotosidebar2" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->fotosidebar2 }}">
