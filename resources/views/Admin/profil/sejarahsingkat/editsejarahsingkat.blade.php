                                        ...
                                        <form action="/updatesejarahsingkat/{{$data->id}}" method="POST" enctype="multipart/form-data">
                                           ...
                                           <div>
                                                ...
                                                <input type="text" name="judul" class="form-control"
                                                    id="defaultFormControlInput" value="{{ $data->judul }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="isi_artikel" class="form-control"
                                                    id="defaultFormControlInput" value="{{ $data->isi_artikel }}"
                                                    aria-describedby="defaultFormControlHelp" />
                                            </div>
                                            <div>
                                                <label for="defaultFormControlInput" class="form-label">Judul Foto Side</label>
                                                <input type="text" name="judul_fotoside" class="form-control"
                                                    id="defaultFormControlInput" value="{{ $data->judul_fotoside }}"
                                                    aria-describedby="defaultFormControlHelp" />
                                            </div>
                                            <br />
                                                 <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Update Foto Side </label>
                            <br/>
                            <img class="img mb-3" src="{{ asset('fotosejarah/' . $data->foto_side) }}" alt="" style="width: 100px;">
                            <input type="file" name="foto" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->foto_side }}">
