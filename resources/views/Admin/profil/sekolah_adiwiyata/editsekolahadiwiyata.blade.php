                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="/updateadiwiyata" method="POST"
                                            ...
                                            <br>
                                            <div class="mb-3">
                                                <img width="500px" src="{{ asset("assets/img/".$data->foto_adiwiyata) }}" alt="">
                                                <label for="exampleInputEmail1" class="form-label">Upload logo
                                                    adiwiyata</label>
                                                <input type="file" name="foto_adiwiyata" class="form-control"
                                                    id="exampleInputEmail1" aria-describedby="emailHelp">
                                                    <i style="float: left;font-size: 11px;color: red">foto harus berukuran 680px x 905px</i>
                                            </div>
                                            <br>
                                            <div>
