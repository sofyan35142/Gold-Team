        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <!-- Content -->
                    <div class="container-xxl flex-grow-1ntainer-p-y">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <h5 class="card-header">Tambah anggota Strukturorganisasi</h5>
                                    <div class="card-body">
                                        <form action="/editsidestrukturorganisasi/{{$data->id}}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama" class="form-control"
                                                    ...
                                                    aria-describedby="defaultFormControlHelp" value="{{$data->nama}}"/>
                                            </div>
                                            <div class="mb-3">
