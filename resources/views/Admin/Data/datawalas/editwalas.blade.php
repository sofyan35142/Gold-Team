...
<!-- / Navbar -->
      ...
      <div class="content-wrapper">
        ...
        <!-- Content -->
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                    <h5 class="card-header">Edit Walas</h5>
                    <div class="card-body">
                        <form action="/data/updatewalas/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                       <div>
                          <div class="mb-3">
        ...
        <br>
                        ...
                        <input type="text" name="nama_walas" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" value="{{ $data->nama_walas }}" />
                        </div>
                        <div>
                        <label for="defaultFormControlInput" class="form-label">kelas</label>
                        <input type="text" name="kelas" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" value="{{ $data->kelas }}" />
                        </div>
                        <br/>
                        <div>
