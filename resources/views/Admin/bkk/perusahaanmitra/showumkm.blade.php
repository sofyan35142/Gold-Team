                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="/editshowumkm/{{$data->id}}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_umkm" class="form-control"
                                                    ...
                                                    aria-describedby="defaultFormControlHelp" value="{{$data->nama_umkm}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="defaultFormControlInput" class="form-label">Bidang :</label>
                                                <input type="text" name="bidang" class="form-control"
                                                    id="defaultFormControlInput"
                                                    aria-describedby="defaultFormControlHelp" value="{{$data->bidang}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="defaultFormControlInput" class="form-label">Alamat :</label>
                                                <input type="text" name="alamat" class="form-control"
                                                    id="defaultFormControlInput"
                                                    aria-describedby="defaultFormControlHelp" value="{{$data->alamat}}"/>
                                            </div>
                                            <div class="mb-3">
                                                <label for="defaultFormControlInput" class="form-label">Pemilik :</label>
                                                <input type="text" name="pemilik" class="form-control"
                                                    id="defaultFormControlInput"
                                                    aria-describedby="defaultFormControlHelp" value="{{$data->pemilik}}"/>
                                            </div>
