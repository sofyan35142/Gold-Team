...
<div class="card mb-4">
  <div class="card-datatable table-responsive pt-0">
    <h5 class="card-header">Kategori Blog</h5>
    <a href="/tambahkategoriblog" type="button" class="btn rounded-pill btn-primary">Tambah</a>
...
<script>
    $('.delete').click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deletekategoriblog/" + kategoriid + ""
