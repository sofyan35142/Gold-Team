...
<div class="card mb-4">
  <div class="card-datatable table-responsive pt-0">
    <h5 class="card-header">KEUNGGULAN</h5>
  ...
  <tbody class="table-group-divider">
    <?php $no = 1; ?>
    @foreach ($data as $keunggulan)
<tr>
        <td>{{ $no }}</td>
        <td>{{ $keunggulan->judul }}</td>
        <td style="word-break: break-all;">{!! $keunggulan->deskripsi !!}</td>
        <td>
            <img src="{{ asset('keunggulan/' . $keunggulan->foto) }}" alt="" style="width: 80px; height:80px;">
        </td>
