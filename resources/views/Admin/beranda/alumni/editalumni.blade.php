          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form action="/beranda/updatealumni/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                        <div>
                        ...
                        <input type="text" name="pekerjaan" class="form-control" id="defaultFormControlInput"  aria-describedby="defaultFormControlHelp" value="{{ $data->pekerjaan }}"/>
                        </div>
                        <br/>
                        ...
                        <div class="mb-3">
                            ...
                            <br/>
                            <img class="img mb-3" src="{{ asset('fotoalumni/' . $data->foto) }}" alt="" style="width: 100px;">
                            <input type="file" name="foto" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->foto }}">
                            <i style="float: left;font-size: 11px;color: red">Foto Harus 310px:415px</i>
                        </div>
