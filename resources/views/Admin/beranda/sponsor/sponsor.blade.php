...
<div class="card mb-4">
  <div class="card-datatable table-responsive pt-0">
    <h5 class="card-header">KERJA SAMA</h5>
    <a href="/beranda/tambahsponsor" type="button" class="btn rounded-pill btn-primary">Tambah</a>
...
<tr>
        <td>{{ $no }}</td>
        <td>
            <img src="{{ asset('sponsor/' . $sponsor->foto) }}" alt="" style="width: 80px; height:80px;">
        </td>


        <td>
            <a href="/beranda/editsponsor/{{ $sponsor->id }}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
            <a href="#" class="btn btn-danger delete" data-id="{{ $sponsor->id }}" data-sambutan="{{ $sponsor->nama }}"><i class="fa-solid fa-trash"></i></a>
        </td>
    </tr>
