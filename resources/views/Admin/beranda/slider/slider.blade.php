...
<tr>
    <td>{{ $no }}</td>
        <td>
            <img src="{{ asset('slider/' . $slider->foto1) }}" alt="" style="width: 80px; height:80px;">
        </td>
        <td>
            <img src="{{ asset('slider/' . $slider->foto2) }}" alt="" style="width: 80px; height:80px;">
        </td>
        <td>
            <img src="{{ asset('slider/' . $slider->foto3) }}" alt="" style="width: 80px; height:80px;">
        </td>
...
<script>
    $('.delete').click(function() {
        ...
        swal({
                ...
                text: "Kamu akan menghapus slider " + slider + "",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/slider/deleteslider/" + sliderid + ""
