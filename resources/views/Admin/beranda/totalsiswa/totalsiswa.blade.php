...
<div class="card mb-4">
  ...
  <thead>
    <tr>
      <th scope="col">No.</th>
      <th scope="col">Judull</th>
      <th scope="col">Laki-Laki</th>
      <th scope="col">Perempuan</th>
      <th scope="col">Tootal Siswa</th>
...
<tr>
        <td>{{ $no }}</td>
        <td>{{ $siswa->judul }}</td>
        <td>{{ $siswa->laki_laki }}</td>
        <td>{{ $siswa->perempuan }}</td>
        <td>{{ $siswa->total_siswa }}</td>
        <td>{{ $siswa->guru }}</td>
...
<script>
    $('.delete').click(function() {
        ...
        swal({
                ...
                text: "Kamu akan menghapus siswa " + siswa + "",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/totalsiswa/deletetotal/" + siswaid + ""
