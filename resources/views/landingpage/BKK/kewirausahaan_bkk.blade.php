            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="service-details-post">
                        ...
                        <div class="row">
                            <div class="col-sm-4"><img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu1.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu2.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu3.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"><img class="mb-3 h-200" src="https://smkn1sukorejo.sch.id/wp-content/uploads/2021/11/8778ccc2-25b2-403d-af23-0a60b92778c8-768x1024.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu2.jpg"
                                    alt="service">
                        ...
                        <h3>WIRAUSAHA KELAS
                            PESERTA DIDIK SMKN 1 SUKOREJO</h3>
                        <div class="row">
                            <div class="col-sm-4"><img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu4.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu5.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu6.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"><img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu7.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaansketsu8.jpg"
                                    alt="service">
                            </div>
                            <div class="col-sm-4"> <img class="mb-3 h-200" src="../assets/img/kewirausahaan9.jpg"
                                    alt="service">
                            </div>
                        </div>
                    </div>
