                ...
                <div class="col-lg-8">
                    ...
                    <div class="blog-details-post">
                        <div class="blog-post-title">
                            ...
                            <p>Bidang Keahlian Teknik dan Rekayasa di SMK Negeri 1 Sukorejo mencakup 5 kompetensi keahlian atau jurusan. Kompetensi keahlian. Program-program kompetensi keahlian tersebut diantaranya:</p>
                        </div>
                        <table class="table table-bordered">
                            <td> <b> No </b></td>
                            <td> <b> Kopetensi Keahlian </b> </td>
                            <td> <b> Ketua Kompetensi Keahlian (KaKomLi) </b> </td>
